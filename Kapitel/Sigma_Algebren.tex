...
\begin{satz} % Satz 5
    Sei $\zeta \subseteq \mathcal{P}\of{E}$ für $E$ nicht-leer ein System von Teilmengen von $E$. Dann existiert eine kleinste $\sigma$-Algebra $\sigma\of{\zeta}$ in $E$, welche $\zeta$ enthält. Das heißt
    \begin{enumerate}[label=(\alph*)]
