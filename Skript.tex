    ...
    \begin{lemma}
        ...
        \begin{proof}
            \begin{align*}
                ...
                \impl A_j &= \sqcup_{k=1}^n \pair{A_j \cap B_k}\\
                \impl B_k &= \sqcup_{j=1}^m \pair{A_j \cap B_k}\\
                \impl \mu\of{A_j} &= \sum_{k=1}^{n} \mu\of{A_j \cap B_k}\\
                \impl \mu\of{B_k} &= \sum_{j=1}^{m} \mu\of{A_j \cap B_k}\\
                \impl \sum_{j=1}^{m} \alpha_j \mu\of{A_j} &= \sum_{j=1}^{m} \sum_{k=1}^{n} \alpha_j\mu\of{A_j \cap B_k}\\
                \impl \sum_{k=1}^{n} \beta_j \mu\of{B_k} &= \sum_{k=1}^{n} \sum_{j=1}^{m} \beta_j\mu\of{A_j \cap B_k}
            \end{align*}
        \end{proof}
    \end{lemma}
