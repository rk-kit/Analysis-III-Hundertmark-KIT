...
\begin{document}
    ...
    \begin{korollar}
        ...
        \begin{align*}
            \sup_{n\in\N} u_n = \sup_{n\in\N} v_n \impl \sup_{n\in\N} \int_{}^{} u \dif \mu = \sup_{n\in\N} \int_{}^{} v \dif \mu
        \end{align*}
    ...
    \begin{notation}
        Wir schreiben $E^n = E^n_+ = E^n_+\of{X, \mA}$ für die Menge aller numerischen meßbaren Funktionen $f\geq 0$ auf $X$, für die es eine wachsende Folge $(u_n)_n \subseteq E_+$ gibt, sodass $\sup_{n\in\N} u_n = f$. Für $f\in E_+^n$ ist dann
        \begin{align*}
