...
\begin{document}
    ...
    \begin{satz}[Nach Carathéodory] % Satz 1
        Sei $\mS\subseteq\mP\of{X}$ ein Halbring und $\mu: \mS \to \interv{0,\infty}$ ein Prämaß. Dann existiert (mindestens) eine Erweiterung von $\mu$ zu einem Maß $\mu$ auf $\sigma\of{\mS}$.\\
        Falls $\mu$ $\sigma$-endlich auf $\mS$ ist, dann ist die Erweiterung eindeutig.
    \end{satz}
